...
import com.hyapp.amplituda.exceptions.io.AmplitudaIOException;
...
final class FileManager {
    ...
    synchronized File getCacheFile(
        ...
        try {
            ...
            throw new AmplitudaIOException(e.getMessage(), com.hyapp.amplituda.ErrorCode.AMPLITUDA_EXCEPTION);
        }
    }
     ...
     */
    synchronized File getRawFile(final int resource, final com.hyapp.amplituda.AmplitudaProgressListener listener) {
     ...
     */
    synchronized File getUrlFile(final String audioUrl, final com.hyapp.amplituda.AmplitudaProgressListener listener) {
     ...
     * @return audio file from local storage
     */
    synchronized File getInputStreamFile(final InputStream audioStream, final com.hyapp.amplituda.AmplitudaProgressListener listener) {
        try {
     ...
     * @return audio file from local storage
     */
    synchronized File getByteArrayFile(final byte[] audioByteArray, final com.hyapp.amplituda.AmplitudaProgressListener listener) {
    ...
    private synchronized void streamToFile(
            ...
            final com.hyapp.amplituda.AmplitudaProgressListener listener
    ) {
        try {
