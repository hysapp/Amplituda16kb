...
Java_linc_com_amplituda_Amplituda_amplitudesFromAudioJNI(
    ...
    if(jlistener != NULL) {
        jclass listener_class = env->FindClass("com/hyapp/amplituda/AmplitudaProgressListener");
    ...
    jclass amplitudaResultClass = (env)->FindClass("com/hyapp/amplituda/AmplitudaResultJNI");
